...
public class JobInfoController {
	...
	@ResponseBody
	@PermissionLimit(limit = false)
	public ReturnT<String> pauseJob(Integer id) {
		return xxlJobService.stop(id);
	}
	 ...
	 * @return
	 */
	@RequestMapping("/cronTriggerTime")
	@ResponseBody
	@PermissionLimit(limit = false)
	public ReturnT<List<String>> cronTriggerTime(String scheduleType, String scheduleConf) {
		XxlJobInfo paramXxlJobInfo = new XxlJobInfo();
		paramXxlJobInfo.setScheduleType(scheduleType);
		paramXxlJobInfo.setScheduleConf(scheduleConf);
	...
	@ResponseBody
	@PermissionLimit(limit = false)
	public Integer getId(String jobDesc) {
		return xxlJobService.getId(jobDesc);
	}

	@RequestMapping("/pageListLog")
	@ResponseBody
	@PermissionLimit(limit = false)
	public Map<String, Object> pageListLog(@RequestParam(required = false, defaultValue = "0") int start,
										@RequestParam(required = false, defaultValue = "10") int length,
										int jobGroup, int triggerStatus, String jobDesc, String executorHandler, String author) {
	...
	@RequestMapping("/getXxlJobInfo")
	@ResponseBody
	@PermissionLimit(limit = false)
	public XxlJobInfo getXxlJobInfo(String jobDesc) {
		return xxlJobService.getXxlJobInfo(jobDesc);
	}
